 ...
 */
int
read_file_new(char *path, int id,struct user_data *ud)
{
	int i = 0;
	int isDigit = 0;
	FILE *fp;
 ...
 */
int
log_attenuation_new(unsigned int att, struct user_data *ud)
{
 ...
 */
int
get_parameters_new(int argc, char *argv[], struct user_data *ud)
{
	int i;
...
void
print_userdata_new(struct user_data *ud)
{
	char* tu;
	if (ud->us == 1)
